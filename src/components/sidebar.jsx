...
import profileImage from "../../public/images/IMG_0664.jpeg"

export default function Sidebar({ data }) {
  const { name, role, education, contactLinks } = data;

  return (
    <div className="bg-sky flex flex-col content-between w-full h-auto sm:h-screen sm:justify-around sm:w-1/3 sm:fixed">
      <div className="text-white flex flex-col p-10 items-center">
        <Image
          priority
          width={275}
          height={275}
          className="rounded-full h-full mb-6 mt-2"
          src={profileImage}
